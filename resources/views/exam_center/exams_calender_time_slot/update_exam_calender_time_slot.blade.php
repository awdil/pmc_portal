        ...
        <div class="col-md-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Update Exam Calender Timeslot</h5>
                </div>
                <div class="ibox-content pb-1">
                    <form class="m-t" role="form" method="post" action="{{ route('update-exam-calender-time-slot', $timeslot->id) }}" id="form_exams_calender_time_slot">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="select-2 form-control  @error('exme_id') is-invalid @enderror" name="exme_id" id="exme_id" data-target="exam_calender_id" data-url="{{ route('list-exam-calendar') }}">
                                        ...
                                        <option {{ $single->id == $timeslot->exam_calander->exam_id ? 'selected' : '' }} value="{{$single->id}}">{{$single->exam_title}}</option>
                                        @endforeach
                                    </select>
                                    @error('exme_id')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="select-2 form-control  @error('exam_center_id') is-invalid @enderror" name="exam_center_id" id="exam_center_id" data-target="exam_calender_id" data-url="{{ route('list-exam-calendar') }}">
                                        ...
                                        <option {{ $single->id == $timeslot->exam_calander->exam_center_id ? 'selected' : '' }} value="{{$single->id}}">{{$single->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="select-2 form-control  @error('exam_calender_id') is-invalid @enderror" name="exam_calender_id" id="exam_calender_id" data-target="" data-url="">
                                        @foreach ($exam_calendar as $single)
                                        <option {{ $single->id == $timeslot->exam_calander->id ? 'selected' : '' }} value="{{$single->id}}">{{ $single->exam_date->format('d/m/Y') }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="exam_begins_at" id="exam_begins_at" type="text" class="form-control @error('exam_begins_at') is-invalid @enderror" placeholder="Please Enter Exam Begins Time" value="{{ $timeslot->exam_begins_at }}" >
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="exam_end_at" id="exam_end_at" type="text" class="form-control @error('exam_end_at') is-invalid @enderror" placeholder="Please Enter Exam End Time" value="{{ $timeslot->exam_end_at }}" >
                                @error('exam_end_at')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="time_from" id="time_from" type="text" class="form-control @error('time_from') is-invalid @enderror" placeholder="Please Enter Arrival Time" value="{{ $timeslot->time_from }}" >
                                @error('time_from')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input name="time_to" id="time_to" type="text" class="form-control @error('time_to') is-invalid @enderror" placeholder="Please Enter Departure Time " value="{{ $timeslot->time_to }}" >
                                @error('time_to')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
