                ...
                <div class="ibox-content">
                    <div class="wrapper wrapper-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="exam-center">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>Country</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        // init datatable.
        var attendanceStatus = $('#exam-center').DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            autoWidth: false,
        ...
        $('#exam-center tbody').on('click', 'td.dt-control', function () {
