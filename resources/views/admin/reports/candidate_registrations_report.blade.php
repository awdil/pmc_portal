    ...
    <div class="col-sm-8">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Candidate Registration Report</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-8">
                ...
                <div class="ibox-content">
                    <div class="wrapper wrapper-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="candidate-registrations">
                                <thead>
                                    <tr>
                                        <th></th>
...
@push('footer_scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            // init datatable.
            var attendanceStatus = $('#candidate-registrations').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                autoWidth: false,
                ...
                order: [[ 1, "desc" ]],
                ajax: {
                    url: "{{ route('report.registrations') }}",
                    data: function ( d ) {
            ...
            $('#candidate-registrations tbody').on('click', 'td.dt-control', function () {
