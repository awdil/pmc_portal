    ...
    <div class="col-sm-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Candidate Payment Report</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-8">
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Candidate Payment Report</h5>
                </div>
                <div class="ibox-content">
                    <div class="wrapper wrapper-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="candidate-payment-status">
                                <thead>
                                    <tr>
                                        <th></th>
...
@push('footer_scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            // init datatable.
            var attendanceStatus = $('#candidate-payment-status').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                autoWidth: false,
                ...
                order: [[ 1, "desc" ]],
                ajax: {
                    url: "{{ route('report.payment-status') }}",
                    data: function ( d ) {
            ...
            $('#candidate-payment-status tbody').on('click', 'td.dt-control', function () {
